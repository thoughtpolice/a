...
export class Canvas2dRenderer implements Renderer {
  ...
  private sourceContext: CanvasRenderingContext2D | OffscreenCanvasRenderingContext2D | null = null;
  ...
  draw(target: Rect): void {
    ...
    // A console frame is scaled by a lot; smoothing it turns pixel art to mud.
