...
// Repairs a private copy of Microsoft.CodeAnalysis.dll for Native AOT. See
// README.md in this directory for the upstream contracts repaired here and
// the equivalent Native AOT diagnostic fallback.
//
//   prepare-roslyn-aot <Microsoft.CodeAnalysis.dll> <output path>
...
if (args.Length != 2)
{
    Console.Error.WriteLine("Usage: prepare-roslyn-aot <Microsoft.CodeAnalysis.dll> <output path>");
    return 2;
}
