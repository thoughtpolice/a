...
Inputs, reference output and the compiled Wasm go in a temporary directory
that is removed afterwards; set `GAMEPLAYC_KEEP_ARTIFACTS=1` to keep it. On failure the runner reports the seed, case
