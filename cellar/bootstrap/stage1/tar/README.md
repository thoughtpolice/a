...
format strings. Full-width header names and link targets are copied into
terminated buffers, preserving all 100 bytes. The obsolete rexec transport is disabled for musl. A remote
...
names and link targets, full 100-byte header name/link fields, hard links, modes, date-based file selection and malformed
