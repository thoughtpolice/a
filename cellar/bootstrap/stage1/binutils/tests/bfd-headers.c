...
int main(void) {
    ...
    CHECK(sizeof(bfd_vma)==8 && sizeof(bfd_size_type)==8 && sizeof(bfd_hostptr_t)==sizeof(void *));
    CHECK(sizeof(file_ptr)==8 && (file_ptr)-1<0 && (ufile_ptr)-1>0);
    CHECK((bfd_uint64_t)1<<63 == UINT64_C(0x8000000000000000));
    CHECK(BFD_VERSION==230000000 && !strcmp(BFD_VERSION_STRING,"2.30"));
