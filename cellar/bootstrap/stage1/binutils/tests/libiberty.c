...
int main(int argc, char **argv) {
    ...
    CHECK(xcrc32((const unsigned char *)"123456789",9,0xffffffffU)==0x0376e6e7U);
    CHECK(xcrc32((const unsigned char *)"56789",5,xcrc32((const unsigned char *)"1234",4,0xffffffffU))==0x0376e6e7U);
